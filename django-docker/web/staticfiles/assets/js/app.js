...
function pauseRecording(){
	...
	if (rec.recording){
		//pause
		rec.stop();
		 pauseButton.innerHTML="<i class='fas fa-play' style='font-size:20px; color:#fffff; margin-top:8px'></i>";

	}else{
		//resume
		rec.record()
		pauseButton.innerHTML="<i class='fas fa-pause' style='font-size:20px; color:#fffff; margin-top:8px'></i>";
